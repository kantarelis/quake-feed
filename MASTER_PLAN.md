...
| 7 | Frontend (React + Vite + TypeScript + Leaflet) | 🟡 In progress | Live map, recent-events timeline, alert-config form. Tailwind + openapi-typescript client + localStorage key + fetch-based SSE. Plan in root `PLAN.md`. |
