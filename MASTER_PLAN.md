...
| 3 | USGS ingestion worker | 🟡 In progress | Celery Beat every 60s; dedupe + revision tracking. Tasks 1–3 done (`bb1c583`, `c2a2326`, `10296ae`); tasks 4–5 pending. See [`PLAN.md`](PLAN.md). |
