...
| 3 | USGS ingestion worker | 🟡 In progress | Celery Beat every 60s; dedupe + revision tracking. Tasks 1–2 done (`bb1c583`, `c2a2326`); tasks 3–5 pending. See [`PLAN.md`](PLAN.md). |
